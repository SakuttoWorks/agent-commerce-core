...
# Import the newly created compliance guardian
...
def search_web(query: str) -> str:
    ...
    # If the search query contains financial or investment terms, immediately trigger an HTTP 400 error (AgentSemanticError) here.
